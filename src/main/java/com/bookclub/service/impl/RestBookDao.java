...
public class RestBookDao implements BookDao {
  ...
  private Object getBooksDoc(String isbnString) {
    ...
    RestTemplate rest = new RestTemplate(); // call the RestTemplate object to invoke a third-party
                                            // API call.
    ...
    UriComponentsBuilder builder =
        UriComponentsBuilder.fromHttpUrl(openLibraryUrl).queryParam("bibkeys", isbnString)
            .queryParam("format", "json").queryParam("jscmd", "details");

    HttpEntity<?> entity = new HttpEntity<>(headers);

    HttpEntity<String> response =
        rest.exchange(builder.toUriString(), HttpMethod.GET, entity, String.class);
  ...
  public List<Book> list() {
  	String isbnString = "ISBN:9780593099332,9780261102361,9780261102378,9780590302715,9780316769532";
